...
# Constants
HOURS_PER_DAY = 8
BASE_SHOOT_MULTIPLIER = 2
SETUP_TIME_BASE = 2
SETUP_TIME_COMPLEX = 2
...
def _create_fallback_scene_cost(scene: SceneData) -> SceneCostBreakdown:
    ...
    shoot_hours = max(2, int(scene.estimated_pages * BASE_SHOOT_MULTIPLIER))
...
def _create_fallback_cost_breakdown(scene_costs: List[SceneCostBreakdown], 
    ...
    budget_range = "High" if high_cost_scenes > len(scene_costs) * HIGH_COST_THRESHOLD else "Medium"
